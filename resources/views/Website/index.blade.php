    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="course-block">
                    <div class="course-img">
                        <img src="{{asset('website/assets/images/course/course1.jpg')}}" alt="" class="img-fluid">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="course-block">
                    <div class="course-img">
                        <img src="{{asset('website/assets/images/course/course2.jpg')}}" alt="" class="img-fluid">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="course-block">
                    <div class="course-img">
                        <img src="{{asset('website/assets/images/course/course3.jpg')}}" alt="" class="img-fluid">
        ...
        <div class="row align-items-center">
             <div class="col-lg-6 col-md-12">
               <div class="about-img2">
                   <img src="{{asset('website/assets/images/bg/choose.png')}}" alt="" class="img-fluid">
               </div>
            </div>
            <div class="col-lg-6 col-md-12">
                <div class="section-heading">
            ...
            <div class="col-lg-12">
                <div class="testimonials-slides owl-carousel owl-theme">
                    <div class="review-item">
                        ...
                        <div class="client-desc">
                            <div class="client-img">
                                <img src="{{asset('website/assets/images/clients/test-1.jpg')}}" alt="" class="img-fluid">
                            </div>
                     ...
                     <div class="review-item">
                        ...
                        <div class="client-desc">
                            <div class="client-img">
                                <img src="{{asset('website/assets/images/clients/test-2.jpg')}}" alt="" class="img-fluid">
                            </div>
                            <div class="client-text">
                                <h4>John Doe</h4>
                                <span class="designation">Developer</span>
                    ...
                    <div class="review-item">
                        ...
                        <div class="client-desc">
                            <div class="client-img">
                                <img src="{{asset('website/assets/images/clients/test-3.jpg')}}" alt="" class="img-fluid">
                            </div>
                            <div class="client-text">
                                <h4>John Doe</h4>
                                <span class="designation">Developer</span>
...
<section class="team section-padding bg-grey">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="team-item">
                    <img src="{{asset('website/assets/images/team/team-4.jpg')}}" alt="" class="img-fluid">
                    <div class="team-info">
                        <h4>Harish Ham</h4>
                        <p>CEO, Developer</p>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="team-item">
                    <img src="{{asset('website/assets/images/team/team-1.jpg')}}" alt="" class="img-fluid">
                    <div class="team-info">
                        <h4>Tanvir Hasan</h4>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="team-item">
                    <img src="{{asset('website/assets/images/team/team-2.jpg')}}" alt="" class="img-fluid">
                    <div class="team-info">
                        <h4>Mikele John</h4>
                        <p>Content Writter</p>
                        <ul class="team-socials list-inline">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="team-item">
                    <img src="{{asset('website/assets/images/team/team-3.jpg')}}" alt="" class="img-fluid">
                    <div class="team-info">
                        <h4>Mikele John</h4>
                        <p>Content Writter</p>
                        <ul class="team-socials list-inline">
...
<section class="blog section-padding">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="blog-item">
                    <img src="{{asset('website/assets/images/blog/news-1.jpg')}}" alt="" class="img-fluid">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog-item">
                    <img src="{{asset('website/assets/images/blog/news-2.jpg')}}" alt="" class="img-fluid">
                    <div class="blog-content">
                        <div class="entry-meta">
                            <span><i class="fa fa-calendar-alt"></i>May 19, 2020</span>
                            <span><i class="fa fa-comments"></i>1 comment</span>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog-item">
                    <img src="{{asset('website/assets/images/blog/news-3.jpg')}}" alt="" class="img-fluid">
                    <div class="blog-content">
                        <div class="entry-meta">
                            <span><i class="fa fa-calendar-alt"></i>May 19, 2020</span>
                            <span><i class="fa fa-comments"></i>1 comment</span>
